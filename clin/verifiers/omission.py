...
class OmissionVerifier:
    def __init__(self):
        self.prompt = """You are an expert fact checker. Find any medications in the patient note that were omitted from the list below and add them to the list. Return the medications as a bulleted list. Return the medication name in quotes and the status in parentheses (active, discontinued, or neither).
