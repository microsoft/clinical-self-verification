...
## Evidence
- zoster vaccine "Safety, tolerability, and immunogenicity after 1 and 2 doses of zoster vaccine"
- placebo "vs. placebo"
...
## Evidence
- propofol "Effect of different rates of infusion of propofol"
...
class EvidenceVerifier:
    ...
    def __call__(self, snippet, bullet_list, llm, verbose=False) -> Dict[str, str]:
