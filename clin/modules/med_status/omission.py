...
PROMPT_V1 = """List all medication names in the patient note that were missed in Extracted medications list. Put the medication name in quotes and the status in parentheses (active, discontinued, or neither). If no additional medications are found, return "None".
